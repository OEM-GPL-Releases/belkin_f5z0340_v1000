...
#define	CONFIG_BOOTARGS "console=ttyS1,57600n8 root=/dev/mtdblock5"
#define	CONFIG_BOOTADR "bc030000"
...
/*
 * Abhishek: 0xbc030000 is the default address to pick the image in OpenWRT
 */
#define OWRT_KERN_ADDR	0xBC030000
...
// Define for symbolic debugging using JTAG debugger ONLY !
