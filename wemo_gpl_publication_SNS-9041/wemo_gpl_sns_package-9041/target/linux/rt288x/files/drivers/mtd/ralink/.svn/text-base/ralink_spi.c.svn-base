...
#define KERNEL_ROOTFS_SIZE     (7616*SIZE_KB)
#define KERNEL_SIZE            (1280*SIZE_KB)
#define ROOTFS_SIZE            (KERNEL_ROOTFS_SIZE - KERNEL_SIZE)

#define KERNEL_1_OFFSET        0x0050000
#define KERNEL_2_OFFSET        (KERNEL_1_OFFSET + KERNEL_ROOTFS_SIZE)

#define ROOTFS_1_OFFSET        (KERNEL_1_OFFSET + KERNEL_SIZE)
#define ROOTFS_2_OFFSET        (ROOTFS_1_OFFSET + KERNEL_ROOTFS_SIZE)
/*
#define KERNEL_1_OFFSET        0x0050000
#define KERNEL_2_OFFSET        0x07C0000

#define ROOTFS_1_OFFSET        0x0150000
#define ROOTFS_2_OFFSET        0x08C0000
*/

/* 
 *  MTD_NUMBER    MTD NAME              START        END
 *  --------------------------------------------------------
 *  MTD 0         uboot                 0000000      0050000
 *  MTD 1         KERNEL_1              0050000      0150000
 *  MTD 2         rootfs_1              0150000      07C0000
 *  MTD 3         KERNEL_2              07C0000      08c0000
 *  MTD 4         rootfs_2              08C0000      0F30000
 *  MTD 5         nvram                 0FE0000      0FF0000
 *  MTD 6         User_Factory          0FF0000      1000000
 *  MTD 7         Factory               0040000      0050000
 *  MTD 8         Belkin_settings       0F30000      0FE0000
 *  MTD 9         Uboot_env             0030000      0040000
 *  MTD 10        flash                 0000000      1000000
 *  MTD 11        FIRMWARE_1            0050000      07C0000
 *  MTD 12        FIRMWARE_2            07C0000      0F30000
*/
static struct mtd_partition rt2880_partitions[] = {
    ...
    }, 
    {
        name:       "Kernel_1",
        size:       KERNEL_SIZE,
        offset:     KERNEL_1_OFFSET,
    }, 
    {
        name:       "rootfs_1",
        size:       ROOTFS_SIZE,  /* 6592 KB */
        offset:     ROOTFS_1_OFFSET,
    },
    {
        name:       "Kernel_2",
        size:       KERNEL_SIZE,
        offset:     KERNEL_2_OFFSET,
    }, 
    {
        name:       "rootfs_2",
        size:       ROOTFS_SIZE,  /* 6592 KB */
        offset:     ROOTFS_2_OFFSET,
    }, 
    {
        name:       "nvram",
        size:       0x10000,  /* 64 KB */
...
static struct mtd_partition rt2880_partitions[] = {
    ...
    {
        name:       "Kernel_1",
        size:       0x100000,  /* 1024 KB */
        offset:     KERNEL_1_OFFSET,
    }, 
    {
        name:       "rootfs_1",
        size:       0x670000,  /* 6592 KB */
        offset:     ROOTFS_1_OFFSET,
    },
    {
        name:       "Kernel_2",
...
#if defined (CONFIG_RT3XXX_EHCI) && defined (CONFIG_RT3XXX_OHCI)
#define KERNEL_ROOTFS_SIZE     (7*SIZE_MB)
#define KERNEL_SIZE            (1280*SIZE_KB)
#define ROOTFS_SIZE            (KERNEL_ROOTFS_SIZE - KERNEL_SIZE)
...
#else
#define KERNEL_1_OFFSET        0x0050000
#define KERNEL_2_OFFSET        0x0750000

#define ROOTFS_1_OFFSET        0x0150000
#define ROOTFS_2_OFFSET        0x0850000
/* 
 *  MTD_NUMBER    MTD NAME            START        END
 *  --------------------------------------------------------
 *  MTD 0         FLASH               0000000      1000000
...
#elif defined (CONFIG_WEMO_FLASH_SMART)
...
static struct chip_info chips_data [] = {
   ...
   { "W25Q128BV",          0xef, 0x40180000, 64 * 1024, 256, 0 }, //Smart
   { "W25Q128FV",          0xef, 0x4018c840, 64 * 1024, 256, 0 },
